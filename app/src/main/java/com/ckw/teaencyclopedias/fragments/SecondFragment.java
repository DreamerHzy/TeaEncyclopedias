 ...
 */
public class SecondFragment extends Fragment implements HotDataCallback {

    private int index = 1;

    private String path = "http://sns.maimaicha.com/api?apikey=b4f4ee31a8b9acc866ef2afb" +
            "754c33e6&format=json&method=news.getListByType&type=16&rows=15&page="+index;
    ...
    private void initPullToRefreshListView(View ret) {
        mPullToRefreshListView = (PullToRefreshListView)
                ret.findViewById(R.id.pullToRefreshListView_2);
