 ...
 */
public class FourthFragment extends Fragment implements HotDataCallback {

    private int index = 1;
    private String path = "http://sns.maimaicha.com/api?apikey=b4f4ee31a8b9acc866ef2afb" +
            "754c33e6&format=json&method=news.getListByType&type=53&rows=15&page="+index;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View ret = inflater.inflate(R.layout.fragment_fourth, container, false);
    ...
    private void initPullToRefreshListView(View ret) {
        mPullToRefreshListView = (PullToRefreshListView)
                ret.findViewById(R.id.pullToRefreshListView_4);
